...
--
--== Automatic Screen Locking Configuration ==--
--
-- Set the idle time in minutes before the screen locks (e.g., 5 minutes).
...
globalkeys = mytable.join(
    ...
    awful.key({ modkey, "Shift"   }, "q", function () awful.spawn("powermenu_t1") end,
