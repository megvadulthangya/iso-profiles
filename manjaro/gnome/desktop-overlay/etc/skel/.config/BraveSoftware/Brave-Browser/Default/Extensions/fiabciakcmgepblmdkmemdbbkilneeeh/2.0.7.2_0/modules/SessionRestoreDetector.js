...
class SessionRestoreDetector {
     ...
     */
    static waitForGroupRestore(options = {}) {
     ...
     */
    static analyzeTabState(tabs, parkUrl) {
        const indicators = {
            hasNormalTabs: false,
     ...
     */
    static shouldProceedWithProcessing(indicators, checkCount, stableChecks, options) {
     ...
     */
    static logCompletionReason(indicators, checkCount, stableChecks, timing, options) {
        const newTabRatio = indicators.hasNewTabPages / Math.max(indicators.totalTabs, 1);
        const hasContent = indicators.hasNormalTabs;
        const waitedMinimum = checkCount >= 10;
...
//# sourceMappingURL=SessionRestoreDetector.js.map