...
class HistoryOpenerController {
    historyPages = {};
    collectInitialTabState(tab) {
        if (this.isHistory(tab.url))
            this.historyPages[tab.id] = true;
    }
    ;
    onTabUpdate(tabId, changeInfo) {
    ...
    reloadHistoryPage() {
        chrome.runtime.getContexts({ documentUrls: [historyPageUrl] }, (contexts) => {
...
//# sourceMappingURL=HistoryOpenerController.js.map